...
1. Существует ли зависимость между возрастом пользователя и возрастным фильтром, который они устанавливают для потенциальных партнеров?
2. Различается ли активность (например, количество лайков и сообщений) между мужчинами и женщинами?
3. Увеличивает ли наличие подключенного аккаунта Instagram/Spotify количество сообщений/совпадений/лайков?
4. Есть ли отличия в количестве сообщений/совпадений/лайков для знаков зодиака?
...
| `DaysWith_matches`                                          | int64      | Относительная   | Количество дней с совпадениями, показывает, как часто пользователь получает новые совпадения.                          |
